...
sed -i "s/database_name_here/$DATABASE_DATABASE_NAME/" /var/www/html/wp-config.php
sed -i "s/username_here/$DATABASE_DATABASE_USER/" /var/www/html/wp-config.php
sed -i "s/password_here/$DATABASE_DATABASE_PASSWORD/" /var/www/html/wp-config.php
